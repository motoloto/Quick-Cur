...
function displayCurrentMappingList() {
    ...
    //   </div>
        ...
        result.currencyMappings.forEach(element => {
            ...
            node.appendChild(createDeleteButton(deleteSelectMap( [map[0], map[1]])));
            node.appendChild(createOrderingButton(deleteSelectMap( [map[0], map[1]])));
           
            var sourceCur = createTextElement(`${map[0]}`);
            node.appendChild(sourceCur);
            
            var transfer = createTextElement(`<i class="bi bi-shuffle "></i>`);
...
function createOrderingButton(action){
    // <button type="button" class="btn secondary btn-sm float-start"><i class="bi bi-grip-vertical "></i></button>

    var button = document.createElement("button");
    button.setAttribute("type","button");
    button.className = "btn secondary btn-sm float-start";

    var item = document.createElement("i");
    item.className = "bi bi-grip-vertical";
...
function createDeleteButton(action){
    // <button type="button" class="btn secondary btn-sm float-start"><i class="bi bi-trash"></i></button>
